...
public class Test2 {
    ...
    public static void main(String[] args) {
        executorService.submit(new LeaderSelectorDistributeTest.ElectionTask(Test2.class.getName(), isMaster));
        consumeExecutorService.submit(new LeaderSelectorDistributeTest.SlaveTask(Test2.class.getName(), isMaster));
    }
}
