...
public class Test0 {
    ...
    public static void main(String[] args) {
        executorService.submit(new LeaderSelectorDistributeTest.ElectionTask(Test0.class.getName(), isMaster));
        consumeExecutorService.submit(new LeaderSelectorDistributeTest.SlaveTask(Test0.class.getName(), isMaster));
    }
}
